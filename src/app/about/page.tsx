  ...
  return (
    <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-10 lg:py-20">
      <div className="space-y-6">
        ...
        <h1 className="max-w-5xl font-display text-5xl leading-tight text-[var(--ink-strong)] sm:text-6xl">
          A mother-daughter wholesale showroom built for better buying.
        </h1>
